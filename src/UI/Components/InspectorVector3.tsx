...
interface InspectorVector3Props {
    ...
    onChanged?: (value: THREE.Vector3) => void;
};
...
export class InspectorVector3 extends React.Component<InspectorVector3Props, InspectorVector3State> {
    public state: InspectorVector3State;
    ...
    private Vector3Equals(v1: THREE.Vector3, v2: THREE.Vector3, epsilon = Number.EPSILON ) {
